 ...
 * @author caoho
 */
public class frmCapNhatTheLoai extends javax.swing.JFrame {
     ...
     */
    public frmCapNhatTheLoai(TheLoai tl) throws SQLException {
        initComponents();
        this.setLocationRelativeTo(null);
        this.setDefaultCloseOperation(frmCapNhatTheLoai.DISPOSE_ON_CLOSE);
        con = new ConnectionToDatabase();
        this.maTheLoai = tl.getMaTheLoai();
        anhXa(tl);
    }

    private frmCapNhatTheLoai() {
        throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
    }
    
    public void anhXa(TheLoai tl)
    {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Cập nhật thể loại");
...
//            f.setVisible(true);
    ...
    private void btn_themActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_themActionPerformed
        ...
        if(tenTheLoai.isEmpty()) {
            ...
            tb.showMessage("Thông báo!", "Vui lòng nhập đúng và đầy đủ nội dung để Cập nhật!");
        } else {
            ...
            try {
                ...
                Logger.getLogger(frmCapNhatTheLoai.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmCapNhatTheLoai.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmCapNhatTheLoai().setVisible(true);
            }
        });
    }
