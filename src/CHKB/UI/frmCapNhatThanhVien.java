 ...
 * @author caoho
 */
public class frmCapNhatThanhVien extends javax.swing.JFrame {
     ...
     */
    public frmCapNhatThanhVien(ThanhVien tv) throws SQLException {
        initComponents();
        this.setLocationRelativeTo(null);
        this.setDefaultCloseOperation(frmCapNhatThanhVien.DISPOSE_ON_CLOSE);
        con = new ConnectionToDatabase();
        this.maThanhVien = tv.getMaThanhVien();
        anhXa(tv);
    }
    
    public void anhXa(ThanhVien tv)
    {
        txt_hoTen.setText(tv.getHoTen());
        txt_soDienThoai.setText(tv.getSoDienThoai());
        txt_ngaySinh.setText(tv.getNgaySinh());
        cbb_gioiTinh.setSelectedItem(tv.getGioiTinh());
        txt_email.setText(tv.getEmail());
        txt_diaChi.setText(tv.getDiaChi());
    }

    private frmCapNhatThanhVien() {
...
//            f.setVisible(true);
    ...
    private void btn_themActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_themActionPerformed
        if(kiemTraRong() == false) {
            ...
            String sql = "set dateformat dmy update ThanhVien set HoTen = N'"+hoTen+"', SoDienThoai = '"+sdt+"', NgaySinh = '"+ngaySinh+"', GioiTinh = N'"+gioiTinh+"', Email = '"+email+"', DiaChi = N'"+diaChi+"' where MaThanhVien = "+ maThanhVien;
            ...
            try {
                ...
                Logger.getLogger(frmCapNhatThanhVien.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    ...
    public boolean kiemTraRong()
    {
        ...
        if (con.kiemTraSo(sdt) == false || sdt.trim().length() > 10) {
            ThongBao tb = new ThongBao(this);
...
//        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmCapNhatThanhVien.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmCapNhatThanhVien().setVisible(true);
            }
        });
    }
