 ...
 * @author caoho
 */
public class frmCapNhaXuatBan extends javax.swing.JFrame {
     ...
     */
    public frmCapNhaXuatBan(NhaXuatBan nxb) throws SQLException {
        initComponents();
        this.setLocationRelativeTo(null);
        this.setDefaultCloseOperation(frmCapNhaXuatBan.DISPOSE_ON_CLOSE);
        con = new ConnectionToDatabase();
        this.maNhaXuatBan = nxb.getMaNhaXuatBan();
        anhXa(nxb);
    }

    private frmCapNhaXuatBan() {
        throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
    }
    
    public void anhXa(NhaXuatBan nxb)
    {
        txt_nxb.setText(nxb.getTenNhaXuatBan());
    }
    /**
...
//            f.setVisible(true);
    ...
    private void btn_themActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_themActionPerformed
        ...
        if(tenNhaXuatBan.isEmpty()) {
            ...
            String sql = "update NhaXuatBan set TenNhaXuatBan = N'"+tenNhaXuatBan+"' where MaNhaXuatBan = "+ maNhaXuatBan;
            ...
            try {
                ...
                Logger.getLogger(frmCapNhaXuatBan.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmCapNhaXuatBan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmCapNhaXuatBan().setVisible(true);
            }
        });
    }
