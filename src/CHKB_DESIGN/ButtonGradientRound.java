...
public class ButtonGradientRound extends JButton {

    private int boGoc = 10;
    
    private Color mauDiemCham = new Color(25, 220, 231, 60);
    private Color mauPhanSang = Color.white;

    public Color getMauDiemCham() {
        return mauDiemCham;
    }

    public void setMauDiemCham(Color mauDiemCham) {
        this.mauDiemCham = mauDiemCham;
    }

    public Color getMauPhanSang() {
        return mauPhanSang;
    }

    public void setMauPhanSang(Color mauPhanSang) {
        this.mauPhanSang = mauPhanSang;
    }
    ...
    public void setBoGoc(int boGoc) {
        this.boGoc = boGoc;
    }
...
//    private Color color1 = Color.decode("#dc19e7");
//    private Color color2 = Color.decode("#19bfe7");
    private Color color1 = new Color(153,0,204);
    private Color color2 = new Color(51,255,255);
    ...
    protected void paintComponent(Graphics grphcs) {
        ...
        g2.setPaint(gra);
//        Area area = new Area(new RoundRectangle2D.Double(0, 0, width, height, boGoc, boGoc));
        g2.fillRoundRect(0, 0, width, height, boGoc, boGoc);
        //  Add Style
        createStyle(g2);
        if (pressed) {
            paintPressed(g2);
...
//        g2.fill(area);
    ...
    private void createStyle(Graphics2D g2) {
        ...
        int width = getWidth();
        int height = getHeight();
        GradientPaint gra = new GradientPaint(0, 0, Color.WHITE, 0, height, mauPhanSang);//Color(255, 255, 255, 60)
        g2.setPaint(gra);
