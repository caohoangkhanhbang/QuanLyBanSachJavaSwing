...
public final class DateChooser extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        cmdForward = new CHKB_DESIGN.DateChooserCustom.Button();
        MY = new javax.swing.JLayeredPane();
        cmdMonth = new CHKB_DESIGN.DateChooserCustom.Button();
        lb = new javax.swing.JLabel();
        cmdYear = new CHKB_DESIGN.DateChooserCustom.Button();
        cmdPrevious = new CHKB_DESIGN.DateChooserCustom.Button();
        slide = new CHKB_DESIGN.DateChooserCustom.Slider();
    ...
    private CHKB_DESIGN.DateChooserCustom.Button cmdForward;
    private CHKB_DESIGN.DateChooserCustom.Button cmdMonth;
    private CHKB_DESIGN.DateChooserCustom.Button cmdPrevious;
    private CHKB_DESIGN.DateChooserCustom.Button cmdYear;
    private javax.swing.JPanel header;
    private javax.swing.JLabel lb;
    private javax.swing.JPopupMenu popup;
    private CHKB_DESIGN.DateChooserCustom.Slider slide;
